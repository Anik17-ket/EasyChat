...
const SignUpPage = () => {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      {/* left side */}
        ...
        <div className="w-full max-w-md space-y-8 relative z-10">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-4 group">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-lg">Get started with your free account</p>
            </div>
          </div>
